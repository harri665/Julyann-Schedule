...
export default function (props: any) {
  ...
  return (
    <Box>
      <Button color="danger"onClick={() => closeDayOverview()}>Close</Button>
      ...
      {peoplestats.map((value: any) => {
        ...
        const [slidervalue, setslidervalue] = useState([value.start,value.end])
        const [textstart, settextstart] = useState(value.start)
        const [textend, settextend] = useState(value.end)
            ...
            <CssVarsProvider defaultMode="dark">
              ...
              <Grid item xs={1}>
                <Button>
                  ...
                  {value.firstname + " " + value.lastname.charAt(0)}
                </Button>
              </Grid>
              ...
              <Grid item xs={0.5}>
                <Button color="danger" onClick={() => removeperson(value)}>X</Button>
              </Grid>
            </CssVarsProvider>
          </Grid>
        );
